          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-800 text-gray-400 text-sm">
                ...
                <th className="p-6 font-medium">Date / Read Time</th>
              ...
              {blogs.map((blog) => (
                ...
                >
                  <td className="p-6 flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-white text-lg max-w-sm truncate">
                        {blog.title}
                      </p>
          ...
          <div className="bg-[#131315] border border-gray-800 rounded-3xl p-8 max-w-sm w-full shadow-2xl relative">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                disabled={isDeleting}
                className={`px-4 py-2 bg-red-600 hover:bg-red-500 text-white rounded-lg font-medium transition-colors ${isDeleting ? "opacity-50" : ""}`}
              >
          ...
          <div className="bg-[#131315] border border-gray-800 rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl relative">
            ...
            <div className="p-8">
              ...
              <div className="space-y-6 text-gray-300">
                <div>
                  <h4 className="text-white font-bold mb-1">Lead Paragraph</h4>
                  <p>{selectedBlog.leadParagraph}</p>
                </div>
                <div>
                  <h4 className="text-white font-bold mb-1">Takeaway</h4>
                  <p className="italic text-blue-400">
                    "{selectedBlog.takeaway}"
                  </p>
                </div>
              </div>
              <div className="mt-8">
                <Link
                  href={`/admin/blog/${selectedBlog.id}`}
                  className="px-6 py-3 inline-block bg-white text-black font-medium rounded-full hover:bg-gray-200 transition-colors"
                >
                  Edit Post
                </Link>
              </div>
